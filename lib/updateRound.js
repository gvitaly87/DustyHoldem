...
const showDown = (table, deck) => {
  ...
  //   table.seats[table.seatsQue[0]].chipCount += table.pot;
  //   table.gameLog += `
  //     <div class="log-winner">
  //     ${table.seats[table.seatsQue[0]].username} wins a pot of ${table.pot}
  //     </div>`;
  // } else {
  ...
  //}
  const tableShowDown = table;
  // for Debugging
  tableShowDown.seats.forEach((seat) => {
    console.log(seat.seat, seat.hand);
  });
